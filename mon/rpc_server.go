...
func updatePgmaps(poolMap *protos.PoolMap, pgMap *protos.PgMaps, osdMap *protos.OsdMap) (*protos.PgMaps, error) {
	var err error
	newPgMaps := *pgMap
	newPgMaps.Pgmaps = make(map[int32]*protos.PgMap)
	for k, v := range pgMap.Pgmaps {
