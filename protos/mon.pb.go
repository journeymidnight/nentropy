...
func (Op_OpType) EnumDescriptor() ([]byte, []int) { return fileDescriptorMon, []int{14, 0} }
...
func (PgConfigRequest_OpType) EnumDescriptor() ([]byte, []int) { return fileDescriptorMon, []int{16, 0} }
...
func (*PgReplica) Descriptor() ([]byte, []int) { return fileDescriptorMon, []int{12} }
...
func (*Pg) Descriptor() ([]byte, []int) { return fileDescriptorMon, []int{13} }
...
func (*Op) Descriptor() ([]byte, []int) { return fileDescriptorMon, []int{14} }
...
func (*Transaction) Descriptor() ([]byte, []int) { return fileDescriptorMon, []int{15} }
...
func (*PgConfigRequest) Descriptor() ([]byte, []int) { return fileDescriptorMon, []int{16} }
...
func (*PgConfigReply) Descriptor() ([]byte, []int) { return fileDescriptorMon, []int{17} }
...
func (*MonAddr) Descriptor() ([]byte, []int) { return fileDescriptorMon, []int{18} }
...
func (*MonMap) Descriptor() ([]byte, []int) { return fileDescriptorMon, []int{19} }
...
var fileDescriptorMon = []byte{
	...
	,
}
