...
func (m *Value) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Len != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintMetadata(dAtA, i, uint64(m.Len))
	}
	if len(m.RawBytes) > 0 {
		dAtA[i] = 0x1a
		i++
...
func (m *StoreIdent) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ClusterID != nil {
		...
		n6, err := m.ClusterID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
var fileDescriptorMetadata = []byte{
	...
	,
}
