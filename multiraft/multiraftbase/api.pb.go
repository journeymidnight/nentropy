...
func (m *BatchResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	n13, err := m.BatchResponse_Header.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n13
	...
	n14, err := m.Responses.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n14
...
var fileDescriptorApi = []byte{
	...
	,
}
