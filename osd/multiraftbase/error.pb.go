...
func (m *KeyNonExistent) Reset()                    { *m = KeyNonExistent{} }
func (m *KeyNonExistent) String() string            { return proto.CompactTextString(m) }
func (*KeyNonExistent) ProtoMessage()               {}
func (*KeyNonExistent) Descriptor() ([]byte, []int) { return fileDescriptorError, []int{9} }
...
func (m *OnodeBroken) Reset()                    { *m = OnodeBroken{} }
func (m *OnodeBroken) String() string            { return proto.CompactTextString(m) }
func (*OnodeBroken) ProtoMessage()               {}
func (*OnodeBroken) Descriptor() ([]byte, []int) { return fileDescriptorError, []int{10} }
...
func (m *DataLost) Reset()                    { *m = DataLost{} }
func (m *DataLost) String() string            { return proto.CompactTextString(m) }
func (*DataLost) ProtoMessage()               {}
func (*DataLost) Descriptor() ([]byte, []int) { return fileDescriptorError, []int{11} }
...
func (*ErrorDetail) Descriptor() ([]byte, []int) { return fileDescriptorError, []int{13} }
...
func (*ErrPosition) Descriptor() ([]byte, []int) { return fileDescriptorError, []int{14} }
...
func (*Error) Descriptor() ([]byte, []int) { return fileDescriptorError, []int{15} }
...
func init() {
	...
	proto.RegisterType((*KeyNonExistent)(nil), "multiraftbase.KeyNonExistent")
	proto.RegisterType((*OnodeBroken)(nil), "multiraftbase.OnodeBroken")
	proto.RegisterType((*DataLost)(nil), "multiraftbase.DataLost")
...
func (this *KeyNonExistent) Equal(that interface{}) bool {
	...
	that1, ok := that.(*KeyNonExistent)
	if !ok {
		that2, ok := that.(KeyNonExistent)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *OnodeBroken) Equal(that interface{}) bool {
	...
	that1, ok := that.(*OnodeBroken)
	if !ok {
		that2, ok := that.(OnodeBroken)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *DataLost) Equal(that interface{}) bool {
	...
	that1, ok := that.(*DataLost)
	if !ok {
		that2, ok := that.(DataLost)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ErrorDetail) Equal(that interface{}) bool {
	...
	if !this.KeyNonExistent.Equal(that1.KeyNonExistent) {
		return false
	}
	return true
}
...
func (m *ErrorDetail) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.KeyNonExistent != nil {
		dAtA[i] = 0x52
		i++
		i = encodeVarintError(dAtA, i, uint64(m.KeyNonExistent.Size()))
		n10, err := m.KeyNonExistent.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (this *ErrorDetail) GetValue() interface{} {
	...
	if this.KeyNonExistent != nil {
		return this.KeyNonExistent
	}
	return nil
}
...
func (m *KeyNonExistent) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KeyNonExistent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KeyNonExistent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *OnodeBroken) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OnodeBroken: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OnodeBroken: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *DataLost) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DataLost: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DataLost: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ErrorDetail) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KeyNonExistent", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.KeyNonExistent == nil {
				m.KeyNonExistent = &KeyNonExistent{}
			}
			if err := m.KeyNonExistent.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorError = []byte{
	...
	,
}
