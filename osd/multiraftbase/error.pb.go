...
func (*StoreNotFoundError) Descriptor() ([]byte, []int) { return fileDescriptorError, []int{10} }
...
func (*ErrorDetail) Descriptor() ([]byte, []int) { return fileDescriptorError, []int{11} }
...
func (*ErrPosition) Descriptor() ([]byte, []int) { return fileDescriptorError, []int{12} }
...
func (*Error) Descriptor() ([]byte, []int) { return fileDescriptorError, []int{13} }
...
var fileDescriptorError = []byte{
	...
	,
}
