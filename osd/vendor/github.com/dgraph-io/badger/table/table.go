...
func (t *Table) DecrRef() error {
	...
	if newRef == 0 { // wuxingyi: 如果ref=0，说明文件可以删除了。
...
// deleting.
func OpenTable(fd *os.File, loadingMode options.FileLoadingMode) (*Table, error) { //wuxingyi: 从一个sst文件load成一个Table
...
func (t *Table) readIndex() error { //wuxingyi: 将所有的block的offset load到内存中。
	readPos := t.tableSize
